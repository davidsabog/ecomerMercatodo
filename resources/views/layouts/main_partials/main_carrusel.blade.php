...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active" style="max-width: 1280px; gap: 10px; margin: 0px auto; padding:10px 0px;">
      ...
      <div class="carousel-item " style="max-width: 1280px; gap: 10px; margin: 0px auto; padding:10px 0px;">
